...
export const sampleAdvisories: AdvisoryData[] = [
  {
    ...
    references: [
      "https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-12345",
      "https://support.microsoft.com/en-us/help/12345"
    ]
  },
  {
    id: "sample-2", 
    ...
    references: [
      "https://blog.sonatype.com/supply-chain-attack-analysis-2024",
      "https://github.com/security-advisories/supply-chain-attack"
    ]
  },
  {
    id: "sample-3",
    ...
    references: [
      "https://security.microsoft.com/phishing-report-2024",
      "https://aka.ms/phishing-defense"
    ]
  }
];