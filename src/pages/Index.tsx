        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 800px; margin: 0 auto 30px auto; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
          <tr>
            <td style="background: white; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
              ...
              ${advisory.references && advisory.references.length > 0 ? `<div style="padding: 15px 0;"><h3 style="margin: 0 0 8px 0; color: #512DA8; font-size: 16px; font-weight: 600;">References</h3><ul style="margin: 0; padding-left: 20px; color: #555; font-size: 14px;">${advisory.references.map(ref => `<li style="margin-bottom: 4px;"><a href="${ref}" style="color: #FF6F00; text-decoration: none;">${ref}</a></li>`).join('')}</ul></div>` : ''}
            </td>
          </tr>
